...
public abstract class AMetabolitePredicate extends Predicate<IMetabolite> implements IMatchPredicate<IMetabolite>{
    ...
    private ICacheDelegate<IMetabolite,TreeMap<Double,Integer>> cache = new CacheFactory<IMetabolite, TreeMap<Double, Integer>>().createDefaultCache(getClass().getName());
