 ...
 */
public class ADescriptorBeanInfo extends SimpleBeanInfo {
    ...
    private static final int PROPERTY_tool = 0;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            ...
            properties[PROPERTY_tool].setPropertyEditorClass ( net.sf.maltcms.chromaui.project.api.beans.GenericDescriptorPropertyEditor.class );
        }
    ...
    public BeanInfo[] getAdditionalBeanInfo() {//GEN-FIRST:Superclass
        Class superclass = net.sf.maltcms.chromaui.project.api.descriptors.ADescriptor.class.getSuperclass();
        BeanInfo sbi = null;
        try {
