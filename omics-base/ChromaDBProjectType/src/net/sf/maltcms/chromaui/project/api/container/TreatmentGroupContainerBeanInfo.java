 ...
 */
public class TreatmentGroupContainerBeanInfo extends SimpleBeanInfo {
    ...
    public BeanInfo[] getAdditionalBeanInfo() {//GEN-FIRST:Superclass
        Class superclass = net.sf.maltcms.chromaui.project.api.container.TreatmentGroupContainer.class.getSuperclass();
        BeanInfo sbi = null;
        try {
