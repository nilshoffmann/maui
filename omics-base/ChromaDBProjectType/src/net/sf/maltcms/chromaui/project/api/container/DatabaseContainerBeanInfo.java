 ...
 */
public class DatabaseContainerBeanInfo extends SimpleBeanInfo {
    ...
    public BeanInfo[] getAdditionalBeanInfo() {//GEN-FIRST:Superclass
        Class superclass = net.sf.maltcms.chromaui.project.api.container.DatabaseContainer.class.getSuperclass();
        BeanInfo sbi = null;
        try {
