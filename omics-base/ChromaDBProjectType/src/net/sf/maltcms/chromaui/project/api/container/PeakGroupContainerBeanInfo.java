 ...
 */
public class PeakGroupContainerBeanInfo extends SimpleBeanInfo {
    ...
    public BeanInfo[] getAdditionalBeanInfo() {//GEN-FIRST:Superclass
        Class superclass = net.sf.maltcms.chromaui.project.api.container.PeakGroupContainer.class.getSuperclass();
        BeanInfo sbi = null;
        try {
