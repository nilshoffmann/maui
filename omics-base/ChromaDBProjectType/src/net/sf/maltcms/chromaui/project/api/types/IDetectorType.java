...
public interface IDetectorType {
    ...
    /**
     * Returns the number of dimensions ONE acquired feature has. For single
     * dimension detectors, such as FID, this is just one dimension. For
     * two-dimensional detectors, such as MS, this is two dimensions.
     *
