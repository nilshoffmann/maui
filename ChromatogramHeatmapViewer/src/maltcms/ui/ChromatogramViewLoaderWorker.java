...
public class ChromatogramViewLoaderWorker extends SwingWorker<ChromMSHeatmapPanel, Void> {
    ...
    public ChromatogramViewLoaderWorker(ChromatogramViewTopComponent cvtc, String file, SettingsPanel sp) {
        this.file = file;
        this.cvtc = cvtc;
        this.sp = sp;
    }
...
//                    eicPlot.setRenderer(new XYLineAndShapeRenderer(true, false));
        ticPlot.setRangeZeroBaselineVisible(true);
        ticPlot.setDomainZeroBaselineVisible(false);
        ticPlot.getDomainAxis().setAutoRange(true);
        ticPlot.getRangeAxis().setAutoRange(true);
...
//        eicPlot.setBackgroundPaint(Color.WHITE);
        ...
        ChromMSHeatmapPanel cmhp = new ChromMSHeatmapPanel(fragment, ticPlot);
