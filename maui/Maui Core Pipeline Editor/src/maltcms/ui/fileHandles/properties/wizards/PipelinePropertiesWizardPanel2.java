...
public class PipelinePropertiesWizardPanel2 implements WizardDescriptor.Panel {

    private PipelineGeneralConfigWidget node;

    public PipelinePropertiesWizardPanel2(PipelineGeneralConfigWidget node) {
        super();
        this.node = node;
    }
    /**
    ...
    public Component getComponent() {
        if (component == null) {
            component = new PipelinePropertiesVisualPanel2(this.node);
        }
        return component;
    }
