...
/**
 * Top component which displays mass spectra received through the current active
 * selection.
 *
...
public final class MassSpectrumViewerTopComponent extends TopComponent {
    ...
    public MassSpectrumViewerTopComponent() {
        ...
        add(new JScrollPane(msp, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED), BorderLayout.CENTER);
