...
//        }
    ...
    private void initComponents() {
        ...
        localeComboBox.setToolTipText(org.openide.util.NbBundle.getMessage(DatabaseDefinitionPanel.class, "DatabaseDefinitionPanel.localeComboBox.toolTipText")); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(databaseContainerName, javax.swing.GroupLayout.Alignment.TRAILING)
		...
		FileFilter fileFilter = new FileFilter() {
			...
			public boolean accept(File file) {
				...
				if (file.getName().toLowerCase().endsWith(".db4o") || file.
						getName().toLowerCase().endsWith(".msp") || file.
			...
			public String getDescription() {
				return "Maui/Maltcms database: .db4o, MSP format: .msp, .txt";
			}
		};
