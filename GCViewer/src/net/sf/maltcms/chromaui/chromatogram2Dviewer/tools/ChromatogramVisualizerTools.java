 ...
 * for details.
 */
package net.sf.maltcms.chromaui.chromatogram2Dviewer.tools;
...
import net.sf.maltcms.chromaui.chromatogram2Dviewer.datastructures.TicProvider;
import net.sf.maltcms.chromaui.chromatogram2Dviewer.ui.panel.ModTimeAndScanRatePanel;
...
//        if (modulationTime > 0) {
        ...
        rt1.setNumberFormatOverride(new RetentionTimeNumberFormatter(
                modulationTime, rtoffset, "#0"));
        double scanrate = modulationTime / (double) height;
        rt2.setNumberFormatOverride(new RetentionTimeNumberFormatter(scanrate, 0,
                "#0.000"));
//        }
