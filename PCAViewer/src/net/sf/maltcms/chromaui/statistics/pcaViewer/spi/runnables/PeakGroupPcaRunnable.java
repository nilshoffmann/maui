 ...
 * $Id$
 */
package net.sf.maltcms.chromaui.statistics.pcaViewer.spi.runnables;
...
//                try {
//                    StatisticsContainer pcaDescriptors = new StatisticsContainer();
//                    pcaDescriptors.setName("pca");
//                    pcaDescriptors.setMethod("PCA");
//                    pcaDescriptors.setDisplayName("Principal Components Analysis");
////                    int maxFactors = 0;
////                    List<double[]> pvalues = new ArrayList<double[]>();
////                    for (IPeakGroupDescriptor descr : container.get()) {
////                        int i = 0;
////                        double[] peakArea = new double[descr.
////                                getPeakAnnotationDescriptors().size()];
...
////                        for (IPeakAnnotationDescriptor pad : descr.
...
////                                Set<IPeakAnnotationDescriptor> set = groupToPeak.
////                                        get(
////                                        treatmentGroup[i]);
////                                set.add(pad);
////                            } else {
...
////                        String rcall = "anovaResult <- aov(peakAreas ~ groups,peaks)";
...
////                        IAnovaDescriptor ad = DescriptorFactory.
////                                newAnovaDescriptor();
...
////
////                                System.out.println("F-values: " + Arrays.
////                                        toString(
////                                        targetfvs));
////                            }
////                        }
...
////
////                                System.out.println("Degrees of freedom: " + Arrays.
////                                        toString(
////                                        targetdvs));
////                            }
////                        }
...
////                        System.out.println("GroupDescriptor:" + ad.
////                                getPeakGroupDescriptor().getDisplayName());
////                        ad.setDisplayName(ad.getPeakGroupDescriptor().
////                                getDisplayName());
////                        anovaDescriptors.add(ad);
////
////
////                    }
...
////
////
////                    List<StatisticsContainer> statContainers = container.
////                            getStatisticsContainers();
...
//        List<double[]> transposedPvalues = new ArrayList<double[]>(pvalues.
//                size());
...
//            int j = 0;
//            for(IStatisticsDescriptor descr:anovaDescriptors.get()) {
