 ...
 * @see Plot
 */
public class FastJFreeChart extends JFreeChart {
     ...
     */
    public FastJFreeChart(Plot plot) {
     ...
     * @param plot  the plot (<code>null</code> not permitted).
     */
    public FastJFreeChart(String title, Plot plot) {
        this(title, FastJFreeChart.DEFAULT_TITLE_FONT, plot, true);
    }
     ...
     */
    public FastJFreeChart(String title, Font titleFont, Plot plot,
    ...
    public void setTitle(String text) {
        if (text != null) {
            if (this.title == null) {
                setTitle(new TextTitle(text, FastJFreeChart.DEFAULT_TITLE_FONT));
            } else {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof FastJFreeChart)) {
            return false;
        }
        FastJFreeChart that = (FastJFreeChart) obj;
    ...
    public static void main(String[] args) {
        System.out.println(FastJFreeChart.INFO.toString());
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        FastJFreeChart chart = (FastJFreeChart) super.clone();
