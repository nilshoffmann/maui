 ...
 */
public class FastChartPanel extends ChartPanel implements ChartChangeListener,
    ...
    private boolean isPanEvent = false;
     ...
     */
    public FastChartPanel(JFreeChart chart) {
     ...
     *                   to <code>false</code>).
     */
    public FastChartPanel(JFreeChart chart, boolean useBuffer) {
     ...
     *                  enabled for the chart.
     */
    public FastChartPanel(JFreeChart chart, int width, int height,
    ...
    public FastChartPanel(JFreeChart chart, int width, int height,
        ...
        this.info.setEntityCollection(new StandardEntityCollection());//new QuadTreeEntityCollection(0,0,Integer.MAX_VALUE,Integer.MAX_VALUE,10));
...
//                @Override
//                public void run() {
//                    System.out.println("Calling setNotify on chart");
