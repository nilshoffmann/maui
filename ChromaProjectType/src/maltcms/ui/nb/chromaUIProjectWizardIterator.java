...
public class chromaUIProjectWizardIterator implements WizardDescriptor./*Progress*/InstantiatingIterator {

    private int index;
    private WizardDescriptor.Panel[] panels;
    private WizardDescriptor wiz;

    public chromaUIProjectWizardIterator() {
    }

    public static chromaUIProjectWizardIterator createIterator() {
        return new chromaUIProjectWizardIterator();
    }

    private WizardDescriptor.Panel[] createPanels() {
        return new WizardDescriptor.Panel[]{
                    new chromaUIProjectWizardPanel(),};
    }

    private String[] createSteps() {
        return new String[]{
                    NbBundle.getMessage(chromaUIProjectWizardIterator.class, "LBL_CreateProjectStep")
                };
    }
