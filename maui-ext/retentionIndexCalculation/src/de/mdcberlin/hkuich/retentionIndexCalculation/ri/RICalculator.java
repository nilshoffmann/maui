 ...
 * for details.
 */
package de.mdcberlin.hkuich.retentionIndexCalculation.ri;
...
public class RICalculator {
	 ...
	 * @param riRTs
	 */
	public RICalculator(int[] numberOfCarbonAtoms, double... riRTs) {
...
//		rts = rirts;
		...
		Arrays.sort(rts);
		RICalculator ric = new RICalculator(cs, rirts);
		for (int i = 0; i < rts.length; i++) {
